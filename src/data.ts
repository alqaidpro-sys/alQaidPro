export const SERVICES_DATA: any[] = [
  {
    ...
    accent: "#f97316",
    items: [
      { id: "temu", name: "مشتريات تيمو", icon: "🛍️", color: "#f97316", badge: "خصم 85%", sub: "شحن مباشر" },
      { id: "ali", name: "علي إكسبريس", icon: "🌐", color: "#3b8fd4", badge: "خصم 80%", sub: "جمارك 4%" },
      { id: "amazon", name: "أمازون مصر", icon: "📦", color: "#f59e0b", badge: "خصم 75%", sub: "وفر 75%" },
      { id: "customs", name: "تخليص جمركي", icon: "🛂", color: "#10b981", badge: "ذكي", sub: "تتبع ذكي" },
    ]
  },
  {
