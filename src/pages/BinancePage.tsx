...
export default function BinancePage({balance=5000,setBalance,onBack}: any){
      ...
      <div dir="rtl" style={{fontFamily:"'Cairo',sans-serif",background:C.bg,minHeight:"100vh",maxWidth:430,margin:"0 auto",paddingBottom:40}}>
        ...
        <div style={{padding:"0 14px",display:"flex",flexDirection:"column",gap:10}}>
          ...
          <button className="btn" onClick={handleBuy} disabled={loading}
            ...
            {loading?<span style={{display:"inline-flex",alignItems:"center",gap:10}}><span style={{width:18,height:18,border:"2px solid rgba(0,0,0,.2)",borderTopColor:"#1a0f00",borderRadius:"50%",animation:"spin 1s linear infinite",display:"inline-block"}}/>جاري الإرسال...</span>:"إرسال الكريبتو ⚡"}
          </button>
