...
async function testConnection() {
  try {
    // Attempt to get a dummy doc to verify connection and database exists
    ...
    if (error.message?.includes('the client is offline')) {
      ...
      console.error(`CRITICAL: Database ${firebaseConfig.firestoreDatabaseId} does not exist in project ${firebaseConfig.projectId}.`);
    } else {
